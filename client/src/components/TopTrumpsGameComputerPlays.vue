<template>
  <div class='top-trumps-game'>
      <div class="player-one">
        ...
        <div id="player-two"> 
            <player-two-stats-computer :playerTwoCurrentCard="playerTwoCurrentCard" :playerOneCurrentCard="playerOneCurrentCard" :computerSelectedStat="computerSelectedStat" />
